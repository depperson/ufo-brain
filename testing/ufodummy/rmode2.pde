...
void rmode2() {
        ...
        if (rmode2_ticks > rmode2_divider) {
          ...
          // update rgb 1
          r1update(rmode2_cur_val_r1, rmode2_cur_val_g1, rmode2_cur_val_b1);
          
          // rgb 2 either mirrors or follows rgb 1
          if (xtalswitch == 1) r2update(rmode2_cur_val_r2, rmode2_cur_val_g2, rmode2_cur_val_b2); else r2update(rmode2_cur_val_r1, rmode2_cur_val_g1, rmode2_cur_val_b1); 
